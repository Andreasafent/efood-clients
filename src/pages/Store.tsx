...
import { ChevronLeftIcon, InformationCircleIcon, PlusIcon, XMarkIcon } from "@heroicons/react/24/outline";
            ...
            <section className="p-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="avatar">
                        <div className="skeleton w-[50px] ring-gray-300 ring-offset-base-100 rounded-full ring ring-offset-2">
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-4">
                    {
                        [1, 2, 3].map(category => (
                            <div key={category}>
                                <h2 className="skeleton h-[28px] w-[120px] mb-2">
                                </h2>
                                <div className="border-b border-black"></div>
                                {
                                    [1, 2, 3].map((product, index, array) => (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <div className="avatar">
                                                    <div className="w-24 rounded-xl skeleton">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    </h2>
                                    {
                                        category.products?.map((product, index, array) => (
                                            <div key={product.id}
                                                ...
                                                className={`relative flex justify-between gap-2 py-3 ${index !== array.length - 1 ? "border-b border-gray-200" : ""}`}
                                            >
                                                <div className="flex flex-col gap-3">
